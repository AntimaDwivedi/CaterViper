...
def die(screen, score):
	f=pygame.font.SysFont('Italic', 40);t=f.render(' GAME OVER : Your score is: '+str(score), True, (255,255,0));screen.blit(t, (10, 270));pygame.display.update();pygame.time.wait(2000);sys.exit(0)
...
appleimage.fill((220, 20, 60));
img = pygame.Surface((20, 20));
img.fill((220,20,60));
f = pygame.font.SysFont('Italic', 20);
